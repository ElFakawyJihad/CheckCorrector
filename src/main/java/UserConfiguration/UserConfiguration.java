...
public class UserConfiguration {
    ...
    public static final String localPath = "D:\\IAGL\\OPL\\PullRequestEngineeringTest";
    public static final String remotePath = "https://user:password@github.com//rbadr/PullRequestEngineeringTest\"";
